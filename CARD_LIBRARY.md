...
| FullAuto | 全自动 | 攻击 | 稀有 | 2 | 单体敌人 | 速射、消耗 | 造成 5/6 点伤害 3 次 | 从爆发过牌改为多段速射攻击，避免复制牌继续抽牌导致爆发过牌回潮 |
...
| TerminalVolley | 终端齐射 | 攻击 | 稀有 | 3 | 全体敌人 | 消耗、生成 Gunspark | 对所有敌人造成 18/24 点伤害并将 2 张枪火火花加入手牌 | 改为稀有 AOE 终端牌，和单体爆发 `枪林弹雨` 拉开定位 |
